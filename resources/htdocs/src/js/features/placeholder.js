 ...
 */
const init = () => {
  delegate(document, { eventType: 'input' }, { 'placeholder.sync': syncPlaceholder });
  delegate(document, { eventType: 'focus' }, { 'placeholder.sync': syncPlaceholder });
  delegate(document, { eventType: 'blur' }, { 'placeholder.sync': syncPlaceholder });
